...
public class MessageController {
    ...
    public List<UserResponse> getNameChats(@PathVariable Long recipientId){
        ...
        List<UserResponse> chats = messages.stream()
                .map(message->new UserResponse(message.getAuthor()))
